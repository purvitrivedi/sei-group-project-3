...
export const deleteHikeReview = (id, reviewId) => {
  return axios.delete(
    `${baseUrl}/hikes/${id}/reviews/${reviewId}`,
    withHeaders()
  );
};
...
export const addCompleted = (userId, hikeId) => {
  return axios.post(
    `${baseUrl}/profiles/${userId}/completed`,
    hikeId,
    withHeaders()
  );
};
...
export const removeHikeRequest = (userId, linkName, hikeId) => {
  return axios.delete(
    `${baseUrl}/profiles/${userId}/${linkName}/${hikeId}`,
    withHeaders()
  );
};
...
export const leaveEvent = (groupId, eventId, parId) => {
  return axios.delete(
    `/api/groups/${groupId}/events/${eventId}/participants/${parId}`,
    withHeaders()
  );
};
...
export const deletePic = (groupId, imageId) => {
  return axios.delete(
    `/api/groups/${groupId}/user-images/${imageId}`,
    withHeaders()
  );
};
