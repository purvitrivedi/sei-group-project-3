        ...
        <div className="container">
          <div className="columns">
            ...
            >
              <h1 className="title">
                <i
                  className="fas fa-mountain mountain"
                  style={{ height: 20 }}
                ></i>
                Create Your Event
                <i
              ...
              >
                <div className="field field-margin">
                  ...
                  <div className="control">
                    <input
                      className={`input ${
                        !this.state.errors.eventName ? "" : "is-danger"
                      }`}
                      type="text"
                ...
                <div className="field field-margin">
                  ...
                  <div className="control">
                    <input
                      className={`input ${
                        !this.state.errors.startDate ? "" : "is-danger"
                      }`}
                      type="date"
                      placeholder="From"
                  ...
                  <div className="control">
                    <Select
                      className={`column is-8 ${
                        !this.state.errors.Hike ? "" : "is-danger"
                      }`}
