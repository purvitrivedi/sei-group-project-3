      ...
      <div className="column is-full">
        <div className="columns">
          <img
            ...
            alt={`pic ${group.name}`}
            className="column group-header-image"
          />
          <div className="column columns is-multiline">
            <div className="column is-full columns is-multiline">
              <h1 className="subtitle column is-full group-title">
                {group.name}
              </h1>
              {members.length > 1 && (
                <p className="column is-full">
                  <i className="fas fa-users"></i>
                  &nbsp;{members.length} hikrs
                </p>
              )}
              <div>
                <figure className="column">
                  <img
                    ...
                    alt={group.createdMember.username}
                    className="group-list-image"
                  />
                  <div>
                    <p>
                      <strong>Created by</strong>: @
                      {group.createdMember.username}{" "}
                    </p>
                    <p className="group-profile-link">
