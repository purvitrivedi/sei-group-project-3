  ...
  return (
    <div className="columns">
      <form
        ...
        className="column is-half is-offset-one-quarter box hike-form"
      >
        <h1 className="title">
          <i className="fas fa-mountain mountain"></i> {title}{" "}
        ...
        <div className="hike-form-fields">
          <div className="field">
            ...
            {errors && errors.name && (
              <small className="help is-danger">Name is required</small>
            )}
          </div>
          <div className="field">
            ...
            {errors && errors.difficulty && (
              <small className="help is-danger">Difficulty is required</small>
            )}
          </div>
          <div className="columns split-row">
            <div className="field column">
              ...
              {errors && errors.distance && (
                <small className="help is-danger">Distance is required</small>
              )}
            </div>
            <div className="field column">
          ...
          <div className="field">
            ...
            {errors && errors.seasons && (
              <small className="help is-danger">Seasons is required</small>
            )}
          </div>
          <div className="field">
            ...
            {errors && errors.country && (
              <small className="help is-danger">Country is required</small>
            )}
          </div>
          <div className="columns split-row">
            <div className="field column">
              ...
              {errors && errors.lat && (
                <small className="help is-danger">Latitude is required</small>
              )}
            </div>
            <div className="field column">
              ...
              {errors && errors.lon && (
                <small className="help is-danger">Longitude is required</small>
              )}
            </div>
          </div>
          ...
          <div className="field">
            ...
            {errors && errors.description && (
              <small className="help is-danger">Description is required</small>
            )}
          </div>
          <div className="field">
            <div className="control">
          ...
          <div className="field">
            <button type="submit" className="button is-fullwidth hike-submit">
              {btnTxt}
            </button>
          </div>
        </div>
