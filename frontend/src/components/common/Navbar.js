...
class Navbar extends React.Component {
  ...
  render() {
    const { hikesIsOpen, communityIsOpen, accountIsOpen, burgerIsOpen } =
      this.state;
        ...
        <div className="container">
          ...
          <div className={`navbar-menu ${burgerIsOpen ? "is-active" : ""}`}>
            <div className="navbar-end">
              {!isAuthenticated() && (
                <Link to="/hikes">
                  <div className="navbar-item main-nav">Hikes</div>
                </Link>
              )}
              {isAuthenticated() && (
                <div
                  className={`navbar-item has-dropdown ${
                    hikesIsOpen ? "is-active" : ""
                  }`}
                  onClick={() => this.handleToggle("hikes")}
                >
                  <span className="main-nav">Hikes</span>
                  <div className="navbar-dropdown">
                    <Link to="/hikes">
                      <div className="navbar-item nav-color">All Hikes</div>
                    </Link>
                    <Link to="/hikes/new">
                      <div className="navbar-item nav-color">
                        Add a New Hike
                      </div>
                    </Link>
                  </div>
              ...
              {!isAuthenticated() && (
                <Link to="/groups" className="navbar-item main-nav">
                  Community
                </Link>
              )}
              {isAuthenticated() && (
                <div
                  className={`navbar-item has-dropdown ${
                    communityIsOpen ? "is-active" : ""
                  }`}
                  onClick={() => this.handleToggle("community")}
                >
                  <span className="main-nav">Community</span>
                  <div className="navbar-dropdown">
                    <Link to="/profiles">
                      <div className="navbar-item nav-color">Hikrs</div>
                    </Link>
                    <Link to="/groups">
                      <div className="navbar-item nav-color">Groups</div>
                    </Link>
              ...
              {!isAuthenticated() && (
                <Link to="/login" className="navbar-item main-nav">
                  Log In
                </Link>
              )}
              {isAuthenticated() && (
                ...
                >
                  ...
                  <div className="navbar-dropdown">
                    <Link to={`/profiles/${userId}`}>
                      <div className="navbar-item nav-color">Profile</div>
                    </Link>
                    <span
                      onClick={this.handleLogout}
                      className="navbar-item nav-color"
                    >
                      Logout
                    </span>
                  </div>
